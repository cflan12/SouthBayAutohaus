...
final class WCC_Genesis_Widget_Column_Classes 
{
	...
	public function widget_form_extend( $instance, $widget ) {
		...
		$row .= '<label for="widget-' . $widget->id_base . '-' . $widget->number . '-column-classes">' . __('Width', 'genesis-widget-column-classes') . ':</label> ';
		...
		$row .= '</select>';
		$row .= ' <label for="widget-' . $widget->id_base . '-' . $widget->number . '-column-classes-first">' . __('First', 'genesis-widget-column-classes') . ':</label> <input type="checkbox" value="1" name="widget-' . $widget->id_base . '[' . $widget->number . '][column-classes-first]" id="widget-' . $widget->id_base . '-' . $widget->number . '-column-classes-first" ' . checked( $instance['column-classes-first'], 1, false ) . '>';
		$row .= '</p>';
